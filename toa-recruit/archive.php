...
<main>
    <section class="p-news-list">
        <div class="p-news-list__title c-title c-title--news js-slideIn">
            <div class="c-title__bar c-title__bar--news c-title__bar_left--news js-bar-first is-light">
                <picture>
                    <source
                        srcset="<?php echo theme_url('images/common/bar-white.png'); ?>"
                        media="(max-width: 768px)" />
                    <img src="<?php echo theme_url('images/common/bar-white.svg'); ?>" alt="">
                </picture>
            </div>
            <h2>News</h2>
            <div class="c-title__bar c-title__bar--news c-title__bar_right--news js-bar-last is-light">
                <picture>
                    <source
                        srcset="<?php echo theme_url('images/common/bar-white.png'); ?>"
                        media="(max-width: 768px)" />
        ...
        <div class="p-news-list__inner">
            <div class="p-news-list__wrapper">
                <ul class="p-news-list__list wow animated fadeInUp">
                    <?php
                    ...
                    if ($posts->have_posts()):
                        ...
                        while ($posts->have_posts()):
                            ...
                            $post_count++;
                    ?>
                            <li class="p-news-list__item <?php if ($post_count > 6) echo 'is-hidden'; ?>">
