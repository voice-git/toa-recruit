    ...
    <section class="p-job">
        ...
        <div class="p-job__content">
            <div class="p-job__inner">
                ...
                ?>
                    <ul class="p-job__list wow animated fadeInUp">
                                    ...
                                    <div class="c-card__inner">
                                        ...
                                        <div class="c-card__texts">
                                            ...
                                            <div class="c-card__text">
                                                <p>
                                                <?php
                                                    if (mb_strlen(get_field('job_description')) > 50) {
                                                        $text = mb_substr(get_field('job_description'), 0, 49);
                                                        echo $text . '…';
                                                    } else {
                                                        echo esc_html(get_field('job_description'));
                                                    }
                                                    ?>
                                                </p>
                                            </div>
