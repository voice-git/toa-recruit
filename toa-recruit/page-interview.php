...
<main>
    ...
    <section class="p-interview">
        ...
        for ($i = 1; $i <= $max_sections; $i++):
            ...
            $image_first_sp = get_field("interview_image01-staff0{$i}_sp");
            ...
            $image_second_sp = get_field("interview_image02-staff0{$i}_sp");
        ...
        ?>
            <div class="p-interview__wrapper">
                <div id="interview<?= $i; ?>" class="p-interview__scrollWrapper">
                    <?php if ($copy_old): ?>
                        <!-- 自動スクロールはクラスにsnap追加 -->
                        <div class="c-label js-label is-area p-interview__area js-scrollify">
                            <div class="c-label__container js-container">
                                <p class="js-slideIn">
                                    <?php echo nl2br(wp_kses_post($copy_old)); ?>
                                </p>
                                <picture>
                                    <source
                                        srcset="<?php echo theme_url('images/interview/not-bar-label-sp.svg'); ?>"
                                        media="(max-width: 768px)" />
                                    <img class="c-not js-interviewNot" src="<?php echo theme_url('images/interview/not-bar-label.svg'); ?>" alt="not">
                                </picture>
                            </div>
                        </div>
                    <?php endif; ?>
                    <!-- 自動スクロールはクラスにsnap追加 -->
                    <div class="p-interview__itemOuter p-interview__itemOuter-<?php echo $i; ?> p-interview__area p-interview__area--item js-scrollify">
                        <div class="p-interview__item js-interview wow animated fadeInUp" data-wow-delay="1s"
                            ...
                            <div class="p-interview__itemInner <?php echo ($i % 2 === 0) ? ' p-interview__itemInner--second' : ''; ?>">
                                <div class="p-interview__itemWrapper">
                                    <div class="p-interview__itemLabel <?php echo ($i % 2 === 0) ? ' p-interview__itemLabel--second' : ''; ?>">
                                        ...
                                        <picture>
                                            <source
                                                srcset="<?php echo theme_url('images/common/not_bar-interview-sp.png'); ?>"
                                                media="(max-width: 768px)" />
                                            <img class="" src="<?php echo theme_url('images/common/not_bar-interview-pc.png'); ?>" alt="not">
                                        </picture>
                                    </div>
                                </div>
                                    ...
                                    <div class="p-interview__itemContainer <?php echo ($i % 2 === 0) ? ' p-interview__itemContainer--second' : ''; ?>">
                                        <div class="p-interview__itemBox">
                                            ...
                                            <div class="p-interview__itemInfo">
                                                <p>
                                                    <?php echo nl2br(wp_kses_post($info)); ?>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="p-interview__content p-interview__content--<?php echo $i; ?> js-scrollify">
                    <div class="p-interview__contentInner wow animated fadeInUp" data-wow-delay=".5s">
                        <?php if ($title_first || $text_first || $image_first): ?>
                            <div class="p-interview__container p-interview__container--<?php echo $i; ?>">
                                    ...
                                    <h3 class="p-interview__contentTitle">
                                        <span>
                                            <span>
                                                ...
                                                <span class="u-pc-tb-only">理由</span>
                                            </span>
                                        </span>
                                            <?php echo nl2br(wp_kses_post($title_first)); ?>
                                    </h3>
                                ...
                                <picture class="p-interview__image">
                                    <source
                                        srcset="<?php echo esc_html($image_first_sp['url']); ?>"
                                        media="(max-width: 768px)" />
                        ...
                        <?php if ($title_second || $text_second || $image_second): ?>
                            <div class="p-interview__container p-interview__container--<?php echo $i; ?>">
                                <div class="p-interview__texts">
                                    <h3 class="p-interview__contentTitle">
                                        <span>
                                            ...
                                            <?php echo nl2br(wp_kses_post($title_second)); ?>
                                    </h3>
                                    <div class="p-interview__text">
                                        <p>
                                ...
                                <picture class="p-interview__image">
                                    <source
                                        srcset="<?php echo esc_html($image_second_sp['url']); ?>"
                                        media="(max-width: 768px)" />
                        ...
                        <div class="p-interview__box">
                            <div class="p-interview__boxInner">
                                ...
                                <div class="p-interview__boxText">
                                    <p>
