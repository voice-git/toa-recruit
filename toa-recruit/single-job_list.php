...
<main>
    <section class="p-job-detail">
        <div class="p-job-detail__titleWrapper">
            <div class="p-job-detail__icon js-slideIn">
                <?php
            ...
            <div class="p-job-detail__title c-title c-title--job js-slideIn">
        ...
        <div class="p-job-detail__inner c-inner js-slideIn">
            ...
            <div class="p-job-detail__list u-pc-tb-only js-slideIn">
            ...
            <div class="p-job-detail__list u-tb-sp-only js-slideIn">
                <?php if ($job_box01 || $job_box02 || $job_box03 || $job_box04): ?>
                    <ul>
                        <?php if ($job_box01): ?>
                            <li>
    ...
    <section class="p-interview-link wow animated fadeInUp">
	    <h2 class="interview-link-title"><img src="<?php echo theme_url('images/job/interview-link-title.svg'); ?>" width="690" height="49" alt="そんなもんじゃなかった社員たち"></h2>
	    <div class="interview-link-wrap">
		    <a href="<?php echo home_url('interview#interview1'); ?>" class="interview-link-block">
	            <picture>
	                <source
	                    srcset="<?php echo theme_url('images/job/interview-link-pe01-sp.jpg'); ?>"
	                    media="(max-width: 768px)" />
	                <img src="<?php echo theme_url('images/job/interview-link-pe01.jpg'); ?>" width="596" height="298" alt="クオリティの管理者">
	            </picture>
			</a>
		    <a href="<?php echo home_url('interview#interview2'); ?>" class="interview-link-block">
	            <picture>
	                <source
	                    srcset="<?php echo theme_url('images/job/interview-link-pp01-sp.jpg'); ?>"
	                    media="(max-width: 768px)" />
	                <img src="<?php echo theme_url('images/job/interview-link-pp01.jpg'); ?>" width="596" height="298" alt="自社ブランドのアンバサダー">
	            </picture>
			</a>
		    <a href="<?php echo home_url('interview#interview3'); ?>" class="interview-link-block">
	            <picture>
	                <source
	                    srcset="<?php echo theme_url('images/job/interview-link-pm01-sp.jpg'); ?>"
	                    media="(max-width: 768px)" />
	                <img src="<?php echo theme_url('images/job/interview-link-pm01.jpg'); ?>" width="596" height="298" alt="補修品ディレクター">
	            </picture>
			</a>
		    <a href="<?php echo home_url('interview#interview4'); ?>" class="interview-link-block">
	            <picture>
	                <source
	                    srcset="<?php echo theme_url('images/job/interview-link-pe02-sp.jpg'); ?>"
	                    media="(max-width: 768px)" />
	                <img src="<?php echo theme_url('images/job/interview-link-pe02.jpg'); ?>" width="596" height="298" alt="仲間と現場を良くしたい監督">
	            </picture>
			</a>
		    <a href="<?php echo home_url('interview#interview5'); ?>" class="interview-link-block">
	            <picture>
	                <source
	                    srcset="<?php echo theme_url('images/job/interview-link-s01-sp.jpg'); ?>"
	                    media="(max-width: 768px)" />
	                <img src="<?php echo theme_url('images/job/interview-link-s01.jpg'); ?>" width="596" height="298" alt="何でもこなすオールラウンダー">
	            </picture>
			</a>
		    <a href="<?php echo home_url('interview#interview6'); ?>" class="interview-link-block">
	            <picture>
	                <source
	                    srcset="<?php echo theme_url('images/job/interview-link-pe03-sp.jpg'); ?>"
	                    media="(max-width: 768px)" />
	                <img src="<?php echo theme_url('images/job/interview-link-pe03.jpg'); ?>" width="596" height="298" alt="自働化をめざす設計士">
	            </picture>
			</a>
		    <a href="<?php echo home_url('interview#interview7'); ?>" class="interview-link-block">
	            <picture>
	                <source
	                    srcset="<?php echo theme_url('images/job/interview-link-pe04-sp.jpg'); ?>"
	                    media="(max-width: 768px)" />
	                <img src="<?php echo theme_url('images/job/interview-link-pe04.jpg'); ?>" width="596" height="298" alt="自動車部品を生み出す人">
	            </picture>
			</a>
		    <a href="<?php echo home_url('interview#interview8'); ?>" class="interview-link-block">
	            <picture>
	                <source
	                    srcset="<?php echo theme_url('images/job/interview-link-pe05-sp.jpg'); ?>"
	                    media="(max-width: 768px)" />
	                <img src="<?php echo theme_url('images/job/interview-link-pe05.jpg'); ?>" width="596" height="298" alt="部品加工マネージャー">
	            </picture>
			</a>
		    <a href="<?php echo home_url('interview#interview9'); ?>" class="interview-link-block">
	            <picture>
	                <source
	                    srcset="<?php echo theme_url('images/job/interview-link-bo01-sp.jpg'); ?>"
	                    media="(max-width: 768px)" />
	                <img src="<?php echo theme_url('images/job/interview-link-bo01.jpg'); ?>" width="596" height="298" alt="社内共有のキーパーソン">
	            </picture>
			</a>
	    </div>
    </section>
    ...
    <section class="p-other-jobs">
        ...
        <div class="p-other-jobs__content wow animated fadeInUp">
