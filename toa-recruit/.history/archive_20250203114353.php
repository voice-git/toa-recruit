...
<main>
    <section class="p-news-list">
        <div class="p-news-list__title c-title c-title--news js-slideIn">
            <div class="c-title__bar c-title__bar--news js-bar-first is-light">
                <picture>
                    <source
                        srcset="<?php echo theme_url('images/common/bar-white-light.svg'); ?>"
                        media="(max-width: 768px)" />
                    <img src="<?php echo theme_url('images/common/bar-white.svg'); ?>" alt="">
                </picture>
            </div>
            <h2>News</h2>
            <div class="c-title__bar c-title__bar--news js-bar-last is-light">
                <picture>
                    <source
                        srcset="<?php echo theme_url('images/common/bar-white-light.svg'); ?>"
                        media="(max-width: 768px)" />
