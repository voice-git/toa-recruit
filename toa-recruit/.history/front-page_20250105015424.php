...
<main>
    ...
    <section class="p-fields">
        ...
        <!-- モーダル（過去のやつ（Topページで選択したやつしか表示されない） 最新にしようとしてる（フィールドのカスタム投稿追加して、フィールドカスタム投稿をトップページのフィールドとして反映、Moreボタン押すと、フィールドの投稿がポップアップとして表示、表示項目はフィールド投稿のチェックボックスで選んだやつ、項目はそれぞれカスタム投稿の職種から持ってきてる。-->
        <?php
        $args = array(
            'post_type' => 'career',
            'paged' => $paged,
