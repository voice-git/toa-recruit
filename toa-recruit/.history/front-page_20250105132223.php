...
<main>
    ...
    <section class="p-news">
        ...
        <div class="p-news__inner c-inner">
            ...
            <div class="p-news__button c-button  -0ms">
    ...
    <section class="p-staff">
        <div class="p-staff__title c-title  -0s">
            <div class="c-title__bar js-bar-first">
                <img src="<?php echo theme_url('images/common/bar-white.svg'); ?>" alt="">
            </div>
    ...
    <section class="p-features">
        <div class="p-features__title c-title c-title--blue  -0s">
            <div class="c-title__bar js-bar-first">
    ...
    <section class="p-fields">
        <div class="p-fields__top">
            <div class="p-fields__title c-title  -0s">
                <div class="c-title__bar js-bar-first">
                    <img src="<?php echo theme_url('images/common/bar-white.svg'); ?>" alt="">
                </div>
                <h2>Career Fields</h2>
    ...
    <section class="p-top-message">
        <div class="p-top-message__title c-title  -0s">
            <div class="c-title__bar js-bar-first">
                <img src="<?php echo theme_url('images/common/bar-white.svg'); ?>" alt="">
            </div>
            <h2>Top Message</h2>
    ...
    <section class="l-other-contents">
        <div class="l-other-contents__title c-title  -0s">
            <div class="c-title__bar js-bar-first">
                <img src="<?php echo theme_url('images/common/bar-white.svg'); ?>" alt="">
            </div>
