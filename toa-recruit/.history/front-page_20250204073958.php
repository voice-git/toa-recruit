...
<main>
        ...
        <div class="p-features__outer">
            <div class="p-features__inner c-inner c-inner--narrow">
                ...
                <ol class="p-features__list p-features__list--first">
                    <li class="p-features__item p-features__item--first js-not-bar js-slideIn">
                    ...
                    <li class="p-features__item p-features__item--second js-not-bar js-slideIn">
                ...
                <ol class="p-features__list p-features__list--second">
                    <li class="p-features__item p-features__item--large js-not-bar js-slideIn">
                    ...
                    <li class="p-features__item p-features__item--small js-not-bar js-slideIn">
                    ...
                    <li class="p-features__item p-features__item--middle js-not-bar js-slideIn">
                ...
                <div class="p-modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-10-title">
                    ...
                    <div class="p-modal__content js-modalContent" id="modal-10-content">
                        <div class="p-modal__texts">
                            ...
                            <p>
                                TOAは操業から一度もリストラをしたことがありません。<br class="u-pc-tb-only">縁あって入社した社員には、できる限り長く活躍してほしいと願っています。<br class="u-pc-tb-only">社会の高齢化で、年金を受給できる年齢が徐々に繰り上げられるなか、<br class="u-pc-tb-only">社員の働き方を工夫して70歳まで働ける環境づくりを進めています。
                            </p>
                        </div>
                    </div>
                    <div class="p-modal__pagination">
                ...
                <?php if ($job_query->have_posts()): ?>
                    <ul class="p-fields__list">
                        <?php while ($job_query->have_posts()) : $job_query->the_post(); ?>
                            <li class="p-fields__item js-slideIn">
                                ...
                                <ul class="p-modal__cards">
                                    ...
                                    ?>
                                                <li class="c-card c-card--modal">
                                                    <a href="<?php the_permalink(); ?>" class="js-cardSlideIn">
    ...
    <section class="p-top-message">
        ...
        <div class="p-top-message__wrapper js-slideIn">
