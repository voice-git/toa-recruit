    ...
    <section class="p-about">
        <div class="p-about__inner c-inner">
            ...
            <div class="p-about__gif">
                <img src="<?php echo theme_url('images/top/gif@2x.webp'); ?>" width="210.27" height="195.36" alt="">
            </div>
                                        ...
                                        <?php if (has_post_thumbnail()) : ?>
                                            ...
                                            <!-- <picture>
                                                <img src="<?php
                                                            ...
                                                            ?>/assets/images/noimage.webp" alt="No image">
                                            </picture> -->
                                        <?php endif; ?>
                                    </div>
    ...
    <section id="features" class="p-features">
        ...
        <div class="p-features__inner c-inner c-inner--narrow">
            ...
            <!-- <picture class="p-features__image">
                <source
                    srcset="<?php echo theme_url('images/top/features-image-01-sp@2x.webp'); ?>"
                    media="(max-width: 768px)" />
                <img src="<?php echo theme_url('images/top/features-image-01-pc@2x.webp'); ?>" width="1338" height="616" alt="">
            </picture> -->
            ...
            <!-- <picture class="p-features__image">
                <source
                    srcset="<?php echo theme_url('images/top/features-image-02-sp@2x.webp'); ?>"
                    media="(max-width: 768px)" />
                <img src="<?php echo theme_url('images/top/features-image-02-pc@2x.webp'); ?>" width="1339" height="617" alt="">
                </picture> -->
        </div>
                ...
                <div class="p-modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-09-title">
                    ...
                    <div class="p-modal__content" id="modal-09-content">
                        ...
                        <!-- <div clss="p-modal__image">
                            <img src="<?php echo theme_url('images/top/modal-01-pc@2x.webp'); ?>" width="281" height="281" alt="">
                        </div> -->
                    </div>
                    <!-- <footer class="p-modal__footer"> -->
                    <div class="p-modal__pagination">
                        ...
                        <div class="p-modal__container p-modal__container--job" role="dialog" aria-modal="true" aria-labelledby="link-<?php the_ID(); ?>-title">
                            ...
                            <div class="p-modal__content p-modal__content--job" id="link-<?php the_ID(); ?>-content">
                                <div class="p-modal__text">
                                    <p>
                                        <?php
                                        if (mb_strlen(get_field('career_text')) > 50) {
                                            $text = mb_substr(get_field('career_text'), 0, 49);
                                            echo $text . …;
                                        } else {
                                            // <!-- 最前線の現場で<br>ものづくりの力を引き出す -->
                                                            ...
                                                            <div class="c-card__texts c-card__texts--modal">
                                                                ...
                                                                <div class="c-card__text c-card__text--modal">
                                                                    <p>
                                                                        ...
                                                                        if (mb_strlen(<?php
                                                                        if (mb_strlen(get_field('career_text'))>50) {
                                                                            $text = mb_substr(get_field('career_text'),0,49) ; echo $text. … ;
                                                                        } else {
                                                                            // <!-- 最前線の現場で<br>ものづくりの力を引き出す -->
                                                                            the_field('career_text');
                                                                        }
