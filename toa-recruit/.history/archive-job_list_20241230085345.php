                ...
                ?>
                    <ul class="p-job__list">
                        <?php while ($job_query->have_posts()) : $job_query->the_post(); ?>
                            <li class="p-job__item c-card">
                                <a href="<?php the_permalink(); ?>">
                                    <div class="p-job__itemImage c-card__image">
                                        <?php
                                    ...
                                    <div class="p-job__itemTexts c-card__texts">
                                        <div class="p-job__itemTitle c-card__title">
                                            <h3>
                                                <!-- 商品企画 -->
