...
<main>
    ...
    <section class="p-fields">
        ...
        <div id="link-01" class="p-modal" aria-hidden="true">
            <div class="p-modal__overlay" tabindex="-1" data-micromodal-close>
                <div class="p-modal__container p-modal__container--job" role="dialog" aria-modal="true" aria-labelledby="link-01-title">
                    ...
                    <?php $job_categories = get_field('job_category');
                    if ($job_categories): ?>
                        ...
                        <ul class="p-modal__cards">
                            <?php foreach ($job_categories as $job_category): ?>
                                <li class="c-card c-card--modal">
                                    <!-- <a href="<?php the_permalink(); ?>"> -->
                                    <a href="<?php echo get_permalink($job_category); ?>">
                                        <div class="c-card__image c-card__image--modal">
                                            <?php
                                            $job_icon = get_field('job_icon', $job_category); // ACF のフィールドから値を取得
                                        ...
                                        <div class="c-card__texts c-card__texts--modal">
                                            <div class="c-card__title c-card__title--modal">
                                                <h3>
                                                    <?php the_field('job_title', $job_category); ?>
                                                    <span>
                                                        <?php the_field('job_english_title', $job_category); ?>
                                                    </span>
                                                </h3>
                                            </div>
                                            ...
                                            <div class="c-card__text c-card__text--modal">
                                                <p>
                                                    <?php the_field('job_description', $job_category); ?>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
                    ...
                    $top_page_id = get_page_by_title('TOP')->ID;

                    // 固定ページに登録されたjob_categoryを取得
                    $job_categories = get_field('job_category', $top_page_id);
                    ...
                    if (!empty($job_categories) && is_array($job_categories)): ?>
                        ...
                        <ul class="p-modal__cards">
                            <?php foreach ($job_categories as $job_category): ?>
                                <li class="c-card c-card--modal">
                                    <a href="<?php echo get_permalink($job_category->ID); ?>">
                                        <div class="c-card__image c-card__image--modal">
                                            <?php
                                            $job_icon = get_field('job_icon', $job_category->ID); // ACF のフィールドから値を取得
                                            if ($job_icon && is_array($job_icon)) : // 配列形式か確認
                                                echo '<img src="' . esc_url($job_icon['url']) . '" alt="' . esc_attr($job_icon['alt']) . '">';
                                            endif;
                                            ?>
                                        ...
                                        <div class="c-card__texts c-card__texts--modal">
                                            <div class="c-card__title c-card__title--modal">
                                                <h3>
                                                    <?php echo esc_html($job_category->job_title); ?>
                                                    <span>
                                                        <?php echo esc_html($job_category->job_english_title); ?>
                                                    </span>
                                                </h3>
                                            </div>
                                            <span class="c-card__circle c-card__circle--modal">
                                            ...
                                            <div class="c-card__text c-card__text--modal">
                                                <p>
                                                    <?php echo the_field($job_description->job_description); ?>
                                                </p>
                                            </div>
                                        </div>
                                    </a>
        ...
        <!-- モーダル（過去のやつ（Topページで選択したやつしか表示されない） -->
        <?php
        $args = array(
            'post_type' => 'job_list',
            'paged' => $paged,
