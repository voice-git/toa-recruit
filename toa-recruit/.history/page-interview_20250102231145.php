                    ...
                    <div class="p-interview__itemWrapper">
                        <div class="p-interview__itemLabel">
                            ...
                            <picture>
                                ...
                                <img src="<?php echo theme_url('images/interview/not-bar-interview-pc.svg'); ?>" alt="飯塚慎一">
                            </picture>
                    ...
                    <div class="p-interview__container">
                        ...
                        <picture class="p-interview__image">
                            <source
                                ...
                                media="(max-width: 768px)" />
                            <img src="<?php echo theme_url('images/interview/interview01-pc@2x.jpg'); ?>" alt="">
                        </picture>
                    </div>
                ...
                <div class="p-interview__itemInner p-interview__itemInner--second">
                    ...
                    <div class="p-interview__itemWrapper">
                        <div class="p-interview__itemLabel p-interview__itemLabel--second">
                            <p>組織の歯車</p>
                            <svg id="not-svg-content" class="c-not" width="605" height="13" viewBox="0 0 605 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <!-- Nの部分 -->
                                <path
                                    id="n-part-staff"
                                    d="M29.5908 0.363885H34.6468V12.5127H30.2133L5.88996 5.49424V12.5127H0.833984V0.363885H5.26746L29.5908 7.38234V0.363885"
                    ...
                    <div class="p-interview__container">
                        <picture class="p-interview__image">
                            <source
                                srcset="<?php echo theme_url('images/interview/interview02-sp@2x.jpg'); ?>"
                                media="(max-width: 768px)" />
                            <img src="<?php echo theme_url('images/interview/interview02-pc@2x.jpg'); ?>" alt="">
                        </picture>
                        <div class="p-interview__texts">
                            <h3 class="p-interview__contentTitle">
                                <span>
