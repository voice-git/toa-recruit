<section class="l-other-contents l-other-contents--second <?php if(is_page('guideline')) echo 'l-other-contents--guideline' ; ?> <?php if(is_page('guideline')) echo 'l-other-contents--guideline' ; ?>">
