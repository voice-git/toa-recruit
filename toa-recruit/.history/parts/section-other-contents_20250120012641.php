<section class="l-other-contents l-other-contents--second is-unfixedClass <?php if(is_page('guideline')) echo 'l-other-contents--guideline' ; ?> <?php if(is_page('message')) echo 'l-other-contents--message' ; ?>">
    ...
    <div class="l-other-contents__inner c-inner l-other-contents__inner--second">
        <ul class="l-other-contents__list l-other-contents__list--second <?php if(is_singular('job_list') || is_post_type_archive('job_list')) echo 'l-other-contents__list--job' ; ?>">
            <?php if (is_page('message') || is_page('data') || is_page('faq') || is_page('guideline')) : ?>
                <li class="l-other-contents__item l-other-contents__item--second is-job js-slideIn">
            ...
            <?php else: ?>
                <li class="l-other-contents__item l-other-contents__item--second is-message js-slideIn">
            ...
            <?php endif; ?>
            <?php if (is_page('data') || is_page('faq') || is_page('guideline')) : ?>
                <li class="l-other-contents__item l-other-contents__item--second is-message js-slideIn">
                    <a href="<?php echo home_url('message'); ?>">
                        <h3 class="l-other-contents__itemTitle l-other-contents__itemTitle--message l-other-contents__itemTitle--second">
                            TOP MESSAGE
            ...
            <?php else : ?>
                <li class="l-other-contents__item l-other-contents__item--second is-data js-slideIn">
            ...
            <?php if (!is_page('guideline')) : ?>
                <li class="l-other-contents__item l-other-contents__item--second is-guidelines js-slideIn">
            ...
            <?php endif; ?>
            <?php if (!is_page('faq')) : ?>
                <li class="l-other-contents__item l-other-contents__item--second is-faq js-slideIn">
