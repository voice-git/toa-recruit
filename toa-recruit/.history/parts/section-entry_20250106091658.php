<section class="l-entry <?php if (!is_front_page()) echo 'l-entry--second'; ?> <?php if (is_page('guideline')) echo 'l-entry--guideline'; ?>">
    <div class="l-entry__box">
        <!-- <picture class="l-entry__image">
            <source
                srcset="<?php echo theme_url('images/common/entry-bg-sp@2x.webp'); ?>"
                media="(max-width: 768px)" />
                <img src="<?php echo theme_url('images/common/entry-bg-pc@2x.webp'); ?>" alt="">
        </picture> -->
