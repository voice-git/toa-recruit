<section class="l-entry is-unfixedClass <?php if (!is_front_page()) echo 'l-entry--second'; ?> <?php if (is_page('guideline')) echo 'l-entry--guideline'; ?> <?php if (is_page('interview')) echo 'l-entry--interview'; ?> ">
