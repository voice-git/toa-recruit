document.addEventListener("DOMContentLoaded", function () {
  ...
  MicroModal.init({
    ...
    onShow: function (modal) {
      gsap.utils.toArray(".js-cardSlideIn").forEach((slide) => {
        const isInViewport =
      ...
      if (match) {
        gsap.utils.toArray(".js-not-modal").forEach((not) => {
          gsap.fromTo(
            ...
            },
            {
              clipPath: "inset(0 0 0 0)",
              // width: "100%",
              filter: "drop-shadow(0px 0px 11.34px rgba(255, 255, 255, 1))",
              ease: "cubic-bezier(0.86, 0, 0.07, 1)",
              duration: 1,
            }
          );
        ...
        document.querySelectorAll(".js-pagination-btn").forEach((button) => {
          button.addEventListener("click", function () {
            ...
            // // **モーダルを閉じる前にclipPathをリセット**
            // gsap.utils
            //   .toArray(".js-not-modal, .js-modalContent")
            //   .forEach((element) => {
            //     gsap.to(element, {
            //       clipPath: "inset(0 100% 0 0)",
            //       filter: "drop-shadow(0px 0px 0px rgba(255, 255, 255, 0))",
            //       // duration: 0.3, // アニメーションを短くする
            //       onComplete: () => {
            //         // **clipPathアニメーションが終わった後にモーダルを閉じる**
            //         MicroModal.close(currentModalId, {
            //           onClose: (modal) = {
            //             gsap.set(`#${currentModalId} .js-not-modal, #${currentModalId} .js-modalContent`, {
            //               clipPath: "inset(0 100% 0 0)",
            //               // filter: "drop-shadow(0px 0px 0px rgba(255, 255, 255, 0))"
            //             });
            //           }
            ...
            //         MicroModal.show(targetModalId, {
            //           onShow: (modal) => {
            //             // 新しいモーダル内の要素を初期状態に設定してからアニメーションを開始
            //             gsap.set(`#${targetModalId} .js-not-modal, #${targetModalId} .js-modalContent`, {
            //               clipPath: "inset(0 100% 0 0)",
            //               // filter: "drop-shadow(0px 0px 0px rgba(255, 255, 255, 0))"
            //             });
                        
            //             // gsap.to(`#${targetModalId} .js-not-modal, #${targetModalId} .js-modalContent`, {
            //             //   clipPath: "inset(0 0 0 0)",
            //             //   filter: "drop-shadow(0px 0px 11.34px rgba(255, 255, 255, 1))",
            //             //   duration: 0.5,
            //             //   ease: "cubic-bezier(0.86, 0, 0.07, 1)"
            ...
            // // gsap.utils.toArray(".js-not-modal, .js-modalContent").forEach((element) => {
            // //   gsap.set(element, {
            // //     clipPath: "inset(0 100% 0 0)",
            // //   });
            // // });
    ...
    onClose: function (modal) {
      ...
      const match = modal.id.match(/^modal-(0[1-9]|10)$/);
      if (match) {
        gsap.utils.toArray(".js-not-modal").forEach((not) => {
          gsap.set(not, {
            clipPath: "inset(0 100% 0 0)",
