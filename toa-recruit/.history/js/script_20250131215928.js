    ...
    ScrollTrigger.matchMedia({
      ...
      "(min-width: 769px)": function () {
        ...
        if (images.length > 0 && contents.length > 0) {
          ...
          // // js-imagesを固定しておく設定
          // gsap.to(".js-pinWrapper", {
          //   scrollTrigger: {
          //     trigger: ".js-images", // js-imagesが含まれる親要素をトリガー
          //     pin: ".js-pinWrapper", // スクロールしても固定
          //     // pinSpacing: "margin",
          //     start: "center center",
          //     end: () =>
          //       "+=" +
          ...
          // gsap.to(".js-inner", {
          //   y: () => -(document.querySelector(".js-inner").offsetHeight - window.innerHeight),
          //   ease: "none",
          //   scrollTrigger: {
          //     trigger: ".js-images", // トリガー要素
          //     pin: ".js-pinWrapper", // ピン留め
          //     start: "top top",
          //     end: () => "+=" + (document.querySelector(".js-inner").offsetHeight - window.innerHeight),
          //     scrub: true, // スクロールと同期
          //   },
          // });
          ...
          // js-pinWrapper を固定する処理（ピン留め）
gsap.to(".js-pinWrapper", {
  scrollTrigger: {
    trigger: ".js-images", // ピン留めの基準
    pin: true, // `true` にして固定
    start: "top top",
    end: () => "+=" + document.querySelector(".js-contents").offsetHeight, // `.js-contents` の高さ分固定
    scrub: true,
  },
});

// .js-inner をスクロールさせる処理
gsap.to(".js-inner", {
  y: () => -(document.querySelector(".js-inner").offsetHeight - window.innerHeight),
  ease: "none",
  scrollTrigger: {
    trigger: ".js-contents", // `.js-contents` 内でスクロール
    start: "top top",
    end: () => "+=" + (document.querySelector(".js-inner").offsetHeight - window.innerHeight),
    scrub: true,
  },
          ...
          //   end: "bottom bottom",
          //   onUpdate: self => {
          //     gsap.set(contents, {y: -self.progress * self.trigger.offsetHeight});
          //   }
          // });
        }
      },
