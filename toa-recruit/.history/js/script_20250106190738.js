document.addEventListener("DOMContentLoaded", function () {
  ...
  MicroModal.init({
    ...
    onShow: function (modal) {
      consto match = modal.id.match(/^modal-(0[1-9]|10)$/); // 正規表現で 01~09 または 10 にマッチ
      // // モーダルが表示されたときに実行
  ...
  if (
    ...
    // console.log("Conditions met: Initializing Parallax.");
  ...
  // else {
  //   console.log("Conditions not met: Parallax not initialized.");
  // }
