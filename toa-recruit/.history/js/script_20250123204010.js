...
//   });
// });
document.querySelectorAll('.js-tab').forEach((tab, index) => {
  tab.addEventListener('click', () => {
    // すべてのタブとコンテンツから選択状態を解除
    ...
    document.querySelectorAll('.js-tab-content')[index].classList.add('is-show');

    console.log(`クリックされたタブのインデックス: ${index}`);
    console.log('表示されるコンテンツ:', document.querySelectorAll('.js-tab-content')[index]);
  });
});
