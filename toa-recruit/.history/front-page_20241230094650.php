...
<main>
    ...
    <section class="p-staff">
        ...
        <div class="p-staff__employees js-wrapper">
            <div class="p-staff__employeesImages js-images">
                <div class="p-staff__employeesImage p-staff__employeesImage--first js-image js-not-sp">
                ...
                <div class="p-staff__employeesImage p-staff__employeesImage--second js-image js-not-sp">
                    <div class="p-staff__employeesSlogan p-staff__employeesSlogan--old">
                        <p>高卒の工場勤務</p>
                        <svg class="c-not not-svg-staff u-pc-only" width="605" height="13" viewBox="0 0 605 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <!-- Nの部分 -->
                ...
                <div class="p-staff__employeesImage p-staff__employeesImage--third js-image js-not-sp">
                    <div class="p-staff__employeesSlogan p-staff__employeesSlogan--old">
                        <p>熱血体育会系営業</p>
                        <svg class="c-not not-svg-staff u-pc-only" width="605" height="13" viewBox="0 0 605 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <!-- Nの部分 -->
                ...
                <div class="p-staff__employeesImage p-staff__employeesImage--fourth js-image js-not-sp">
                    <div class="p-staff__employeesSlogan p-staff__employeesSlogan--old">
                        <p>大工場の一つの駒</p>
                        <svg class="c-not not-svg-staff u-pc-only" width="605" height="13" viewBox="0 0 605 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <!-- Nの部分 -->
                ...
                <div class="p-staff__employeesImage p-staff__employeesImage--fifth js-image js-not-sp">
                    <div class="p-staff__employeesSlogan p-staff__employeesSlogan--old">
                        <p>知識ゼロの文系出身</p>
                        <svg class="c-not not-svg-staff u-pc-only" width="605" height="13" viewBox="0 0 605 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <!-- Nの部分 -->
                ...
                <div class="p-staff__employeesImage p-staff__employeesImage--sixth js-image js-not-sp">
                    <div class="p-staff__employeesSlogan p-staff__employeesSlogan--old">
                        <p>高卒の工場勤務</p>
                        <svg class="c-not not-svg-staff u-pc-only" width="605" height="13" viewBox="0 0 605 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <!-- Nの部分 -->
    ...
    <section class="p-features">
        ...
        <div class="p-features__inner c-inner c-inner--narrow">
            ...
            <ol class="p-features__list p-features__list--first">
                <li class="p-features__item p-features__item--first js-not-features-normal">
                ...
                <li class="p-features__item p-features__item--second js-not-features-normal">
            ...
            <ol class="p-features__list p-features__list--second">
                <li class="p-features__item p-features__item--large js-not-features-large">
                ...
                <li class="p-features__item p-features__item--small js-not-features-small">
                ...
                <li class="p-features__item p-features__item--middle js-not-features-small">
    ...
    <div class="p-fields__top">
        <div class="p-fields__title c-title js-fadein js-fadein-0s">
            <div class="c-title__bar js-bar-first">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/bar-white.svg" alt="">
            </div>
            <h2>Career Fields</h2>
            <div class="c-title__bar js-bar-last">
                <img src="<?php echo get_template_directory_uri(); ?>/images/common/bar-white.svg" alt="">
        ...
        <div class="p-fields__slogan">
            <picture>
                <source srcset="<?php echo get_template_directory_uri(); ?>/images/top/fields-slogan-sp.svg" media="(max-width: 576px)" />
                <img src="<?php echo get_template_directory_uri(); ?>/images/top/fields-slogan-pc.svg" alt="あなたの力を引き出すフィールドがある">
            </picture>
        </div>
                    ...
                    <?php while ($job_query->have_posts()) : $job_query->the_post(); ?>
                        <li class="p-fields__item">
                            ...
                            <picture class="p-fields__field">
                                <source srcset="<?php echo get_template_directory_uri(); ?>/images/top/field-sp.svg" media="(max-width: 768px)" />
                                <img src="<?php echo get_template_directory_uri(); ?>/images/top/field.svg" alt="">
                            </picture>
    ...
    <?php if ($job_query->have_posts()) : ?>
        <?php while ($job_query->have_posts()) : $job_query->the_post(); ?>
            <div id="link-<?php the_ID(); ?>" class="p-modal" aria-hidden="true">
                <div class="p-modal__overlay" tabindex="-1" data-micromodal-close>
                    <div class="p-modal__container" role="dialog" aria-modal="true" aria-labelledby="link-<?php the_ID(); ?>-title">
                        <header class="p-modal__header">
                            <h3 class="p-modal__title" id="modal-<?php the_ID(); ?>-title"><?php the_field('job_title'); ?></h3>
                            <button class="p-modal__close" aria-label="Close modal" data-micromodal-close>
                                <svg width="27" height="27" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 1L26 26" stroke="white" stroke-width="2" />
                                    <path d="M26 1L1 26" stroke="white" stroke-width="2" />
                        ...
                        <div class="p-modal__content" id="link-<?php the_ID(); ?>-content">
