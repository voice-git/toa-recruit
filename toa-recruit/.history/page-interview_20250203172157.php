        ...
        ?>
            <div class="p-interview__wrapper">
                <div id="interview<?= $i; ?>" class="p-interview__scrollWrapper">
                    <?php if ($copy_old): ?>
                        <div class="c-label js-label is-area p-interview__area js-scrollify snap">
                    ...
                    <div class="p-interview__itemOuter snap p-interview__itemOuter-<?php echo $i; ?> p-interview__area p-interview__area--item js-scrollify">
                            ...
                            <div class="p-interview__itemInner <?php echo ($i % 2 === 0) ? ' p-interview__itemInner--second' : ''; ?>">
                                <div class="p-interview__itemWrapper">
                                    <div class="p-interview__itemLabel <?php echo ($i % 2 === 0) ? ' p-interview__itemLabel--second' : ''; ?>">
                                        ...
                                        <picture>
                                            <source
                                                srcset="<?php echo theme_url('images/interview/not_bar-interview-sp.svg'); ?>"
                                                media="(max-width: 768px)" />
                                            <img class="js-interviewSlideIn" src="<?php echo theme_url('images/interview/not_bar-interview-pc.svg'); ?>" alt="not">
                                        </picture>
                                    </div>
                                </div>
                ...
                <div class="p-interview__content p-interview__content--<?php echo $i; ?> js-scrollify">
                    <div class="p-interview__contentInner">
                        ...
                        <div class="p-interview__box">
                            <div class="p-interview__boxInner js-slideIn">
