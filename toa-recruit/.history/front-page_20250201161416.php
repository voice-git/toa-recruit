                ...
                <div class="p-modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-07-title">
                    ...
                    <div class="p-modal__content" id="modal-07-content">
                        <div class="p-modal__texts">
                            ...
                            <p>
                            スキーをはじめテニス、ゴルフなどを楽しめる保養所（水上·草津）のほか、<br class="u-pc-tb-only">各種のクラブ活動なども活発に行っています。<br class="u-pc-tb-only">家賃補助や、食事補助、自動車購入資金融資制度、奨学金返還補助、社員旅行など 安心して長く働けられるように、手厚いサポート体制を揃えています。
