                ...
                <div class="p-modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-01-title">
                    ...
                    <div class="p-modal__content" id="modal-01-content">
                        <div class="p-modal__texts">
                            <h4>合言葉は“共に育つ”。</h4>
                            <p>
                                TOAの“共育”は、ベテラン社員が若手を教え、その若手が後輩を指導することで、<br class="u-pc-tb-only">教える側も学びながら成長する仕組みです。<br class="u-pc-tb-only">安全・品質体験、ものづくり、技術者養成などを通じて、 社員が個性と能力を最大限に発揮し、高い専門性を習得できます。
