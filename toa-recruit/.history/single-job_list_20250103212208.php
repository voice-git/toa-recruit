        ...
        <div class="p-job-detail__inner c-inner">
            ...
            <div class="p-job-detail__content">
                <ul>
                    <li>
                        <div>
                            <?php if(get_field('job_detail_image01')): ?>
                                <img src="<?php the_field('job_detail_image01')" alt="">



                            <?php
                            $job_image_url = get_field('job_detail_image01'); // フィールドからURLを取得

                            if ($job_image_url) : // URLが存在する場合
                            ?>
                                <div class="p-job__itemImage">
                                    <img src="<?php echo esc_url($job_image_url); ?>" alt="職種画像">
                                </div>
                            <?php endif; ?>
                            <!-- <img src="" alt=""> -->
                        </div>
                        <div>
                            <h3>
                                <?php the_field('job_detail_headline01'); ?>
                            </h3>
                            <p>
                    ...
                    <li>
                        <div>
                            <?php
                            $job_image_url = get_field('job_detail_image02'); // フィールドからURLを取得
                        ...
                        <div>
                            <h3>
                                <?php the_field('job_detail_headline02'); ?>
                            </h3>
                            <p>
                                <?php the_field('job_detail_text01'); ?>
                            </p>
                    ...
                    <li>
                        <div>
                            <?php
                            $job_image_url = get_field('job_detail_image03'); // フィールドからURLを取得
                        ...
                        <div>
                            <h3>
                                <?php the_field('job_detail_headline03'); ?>
                            </h3>
                            <p>
                    ...
                    <li>
                        <div>
                            <?php
                            $job_image_url = get_field('job_detail_image04'); // フィールドからURLを取得
                        ...
                        <div>
                            <h3>
                                <?php the_field('job_detail_headline04'); ?>
                            </h3>
                            <p>
                    ...
                    <li>
                        <div>
                            <?php
                            $job_image_url = get_field('job_detail_image05'); // フィールドからURLを取得
                        ...
                        <div>
                            <h3>
                                <?php the_field('job_detail_headline05'); ?>
                            </h3>
                            <p>
                    ...
                    <li>
                        <div>
                            <?php
                            $job_image_url = get_field('job_detail_image06'); // フィールドからURLを取得
                        ...
                        <div>
                            <h3>
                                <?php the_field('job_detail_headline06'); ?>
                            </h3>
                            <p>
