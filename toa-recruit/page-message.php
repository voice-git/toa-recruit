<?php get_header(); ?>
<main>
    <section class="p-message js-slideIn">
        <div class="p-message__container">
            <div class="p-message__inner c-inner u-pc-tb-only">
                <h2 class="p-message__title js-slideIn">
                    Top Message
                </h2>
                <div class="p-message__top js-slideIn">
                    <p>
                        あなたは潜在能力を眠らせている。<br>
                        その秘めた力を引き出すことが<br>
                        私の重要な仕事です。
        ...
        <div class="p-message__content js-slideIn">
            ...
            <div class="p-message__inner c-inner">
                <p class="p-message__text">
                    ...
                    <br>
                    製造業は地味かもしれません。<br class="u-pc-tb-only">
                    TOAもまた派手な企業ではないかもしれません。<br class="u-pc-tb-only">
                    でも、私たちは世界で戦える力をもった企業です。<br class="u-pc-tb-only">
                    これから入社する方も、経験と努力をコツコツと積み重ねていけば、<br class="u-pc-tb-only">
                    気がつくと世界基準の何かを手にすることができるはずです。<br class="u-pc-tb-only">
                    年齢を重ねるたびに能力を身につけ、<br class="u-pc-tb-only">
                    正しく評価され、期待されるキャリア形成を共に築いていきましょう。<br class="u-pc-tb-only">
                    私たちはあなたの人生にコミットし、<br class="u-pc-tb-only">
